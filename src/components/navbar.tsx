...
export default function Navbar() {
    ...
    return (
        <nav id="navbar" className="gap-10 items-center sticky top-0 z-1000 flex border-b-3 border-border justify-between pb-3 pt-3 bg-background text-center">
          ...
          className='lg:hidden md:inline sm:inline lg:invisible p-3 mr-5 bg-button hover:bg-button-hover rounded text-highlight'>
            {dropdown ? <IoMdClose aria-hidden="true" /> : <IoMenu aria-hidden="true" /> }
          </motion.button>
          {dropdown && (
