...
// template contact form i only adjusted style
    ...
    return (
        <div className="flex justify-center items-center min-h-[60vh] bg-background py-8">
            <div className="w-full max-w-md">
                ...
                >
                    <h2 className="text-2xl font-bold mb-6 text-text text-center">Contact Me</h2>
                    <div className="mb-4">
                        <label htmlFor="name" className="block text-text font-medium mb-1">Name</label>
                        <input
                            type="text"
                            name="name"
                            required
                    ...
                    <div className="mb-4">
                        <label htmlFor="email" className="block text-text font-medium mb-1">Email</label>
                        <input
                            type="email"
                            name="email"
                            required
                    ...
                    <div className="mb-6">
                        <label htmlFor="message" className="block text-text font-medium mb-1">Message</label>
                        <textarea
                            name="message"
                            required
                            rows={4}
